...
> 📖 **运营者请直接看 [使用说明.md](使用说明.md)**——不写代码也能上手:换店铺知识库、工作台接管、排查手册全在里面。
> 🔧 **要改代码/内容的维护者(包括 AI)先读 [CLAUDE.md](CLAUDE.md)**——铁律、改什么动哪个文件、每类修改的验证命令、禁区清单;内容区(话术/知识/商品)另见 [prompts/README.md](prompts/README.md)。
...
| [技术文档 · 真机联调SOP](docs/技术文档/07-真机联调SOP.md) | 分：微信客服公网回调联调手册（双路径/故障速查/验收清单） |
| [技术文档 · 智能机器人实录](docs/技术文档/08-智能机器人长连接与真机联调实录.md) | 分：长连接协议/适配器设计/**关键困难点**/真机测试实录 |
| [技术文档 · 难点与决策记录](docs/技术文档/09-关键难点与决策记录.md) | 分：产品/技术/测试三侧难点与决策日志（含双 AI 协作纪律） |
| [技术文档 · 评测与质量门禁](docs/技术文档/10-评测与质量门禁.md) | 分：evals 三层评测架构、合规换版门禁、金标断言经验 |
| [测试文档](docs/测试文档/00-总览.md) | 测试策略、离线用例、评测集、已知结果、**测试台账**（06） |
| [产品化路线图](docs/产品化路线图.md) | 三视角审计+对抗验证的 P0/P1/P2 及执行状态 |
